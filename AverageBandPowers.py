        ...
        if state == 0:
            ...
            if ready == 1:
                ...
                for i in channelList: 
                    ...
                    if result == 0:    #EDK_OK
                        print i
                        print "%.6f, %.6f, %.6f, %.6f, %.6f" % (thetaValue.value, alphaValue.value, 
                        ...
                        listData.extend((thetaValue.value, alphaValue.value,low_betaValue.value, high_betaValue.value, gammaValue.value))
                print "\n"
